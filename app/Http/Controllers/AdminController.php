...
class AdminController extends Controller
{
    ...
    {
        $this->data['sub_menu'] = 'users-admin-show';
    ...
    public function store(AddUserRequest $request)
    {
        ...
        $user->attachRole(9);
        return redirect()->route('admin.index')->with('status', trans('users.add_success'));
    }
            ...
            ->addColumn('active', function ($model) {
                ...
                $element = "
                            <div class='col-xs-6' style='width: 35%!important;'>
                                ...
                                <a class='btn btn-danger btn-sm delete' title='حذف'><input type = 'hidden' class='id_hidden' value = '" . $id . "' > <i class='fa fa-remove' ></i ></a >
                            </div>  
                        ";
