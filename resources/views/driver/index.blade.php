                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="btn-group">
                                                <a href="{{ route('drivers.create') }}" id="sample_editable_1_new"
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                ...
                ajax: {
                    url: '{{url("/")}}/driver/contentListData',
                    type: 'POST',
                    'headers': {
            ...
            $('#data-table_wrapper').on('change' , '.statusFilter3' , function() {
                ...
                var new_url = '{{url("/")}}/driver/contentListData/' + filter_value;
                            ...
                            if (e.data == 0) {
                               ...
                               // $.toaster({priority: 'danger', message: message});
                                ...
                                if (active == -1) {
                                    ...
                                    if (selected != "all") {
                                        var new_url = '{{url("/")}}/driver/contentListData/' + 1;
                                        table.ajax.url(new_url).load();
                                    }
