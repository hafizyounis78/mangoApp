                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="caption-subject bold uppercase"> {{trans('instruction.display_instruction')}}</span>
                                </div>
                            ...
                            <div class="portlet-body">
                                <div class="table-toolbar">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="btn-group">
                                                <a href="{{ url('instructions/create') }}" id="sample_editable_1_new"
                                                   class="btn sbold green">{{trans('instruction.add_instruction')}}
                                                </a>
                                ...
                                <table id="data-table"
                                    ...
                                    <tr>
                                        ...
                                        -->
                                        <th>{{trans('instruction.title')}}</th>
                                        <th>{{trans('instruction.image')}}</th>
                                        <th>{{trans('instruction.description')}}</th>
                                        <th>{{trans('instruction.order')}}</th>
                                        <th>{{trans('instruction.status')}}</th>
                                        <th>{{trans('instruction.add_date')}}</th>
                                        <th>{{trans('instruction.control')}}</th>
    ...
    <script>
        ...
        $(function () {
            ...
            var table = $('#data-table').DataTable({
                ...
                ajax: {
                    url: '{{url("/")}}/instructions/contentListData',
                    type: 'POST',
                    data: function (d) {
