    ...
    <link rel="shortcut icon" href="favicon.ico" /> 
     <style>
        @font-face {
            ...
            src: url("{{url('')}}/fonts/helveticaneueltarabic-roman-42.ttf") ;
        }
...
<div class="logo">
    <a href="index.html">
        <img src="{{url('/')}}/img/ic_launcher_round.png" alt="" width="8%"/> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
    <!-- BEGIN LOGIN FORM -->
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" type="email" autocomplete="off" placeholder="البريد الإلكتروني" name="email" /> </div>
        <div class="form-group">
...
<div class="copyright"> 2018 © Madar </div>
<!--[if lt IE 9]>
